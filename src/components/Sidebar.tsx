    ...
    */
    {
      icon: LinkIcon,
      label: 'LinkedIn',
      value: 'linkedin.com/in/rafiou',
      href: 'https://www.linkedin.com/in/rafiou/'
    },
    {
      icon: CodeBracketIcon,
      label: 'GitHub',
      value: 'github.com/Econowiz',
      href: 'https://github.com/Econowiz'
    },
    {
      icon: MapPinIcon,
      label: 'Currently in',
      value: 'Lucerne, Switzerland • UTC+1',
      href: null
    }
  ]

  const socialLinks = [
    { name: 'LinkedIn', url: 'https://www.linkedin.com/in/rafiou/', icon: SiLinkedin },
    { name: 'GitHub',   url: 'https://github.com/Econowiz',     icon: SiGithub },
