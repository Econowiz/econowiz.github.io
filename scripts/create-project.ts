...
Types: standard, interactive, case-study, dashboard
  ...
  await fs.writeFile(
    path.join(projectDir, 'datasets', 'main-data.json'),
  ...
  console.log(`📊 Add datasets: ${path.join(projectDir, 'datasets')}`)
  console.log(`🖼️  Add images: ${path.join(projectDir, 'images')}`)
  console.log(`📎 Add attachments: ${path.join(projectDir, 'attachments')}`)
  console.log(`\n🚀 Next steps:`)
  console.log(`1. Edit metadata.json with your project details`)
  console.log(`2. Add your datasets to the datasets folder`)
  console.log(`3. Add project images to the images folder`)
